...
#### Save voice
The **Save voice** button persists your voice source and voice selection to the agent's settings. It is the save action for this sub-tab only; the Voice call sub-tab has its own Reset and Save controls.
