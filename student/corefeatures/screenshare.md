...
<iframe width="560" height="315" src="https://www.youtube.com/embed/eimzO8YJ5nc" title="YouTube video player" frameborder="0" allowfullscreen></iframe>


<iframe width="560" height="315" src="https://www.youtube.com/embed/By2oyDTlq2k" title="YouTube video player" frameborder="0" allowfullscreen></iframe>


<iframe width="560" height="315" src="https://www.youtube.com/embed/dSJO3_jjAc4" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
...
Receive precise directions (“Click the Create + button…”) as you navigate complex workflows.

#### Live Confirmation & Troubleshooting

Ask questions like  
> “Did my resource finish training?”  
and get immediate reassurance or corrections.
...
You choose exactly which window or tab to share and can stop sharing at any moment.
...
- Hover over the **desktop‑screen icon** in the lower‑right corner of the prompt box  
- Click the **icon**  
- Select the **browser tab or window** you wish to share and approve the prompt
...
Close the screen‑share window or click **Stop Sharing** to end the session.

---

## How to Use (Screensharing Transcript)
...
Learners who struggle with written instructions benefit from **visual, real‑time guidance** accompanied by **voice or text explanations**.
