...
- [MCP Server Connections](/developer/platform/mcp/mcp-connections) — register servers, create connections, attach to agents.
- [OAuth Connectors](/developer/platform/mcp/oauth-connectors) — per-user OAuth authorization flow.
- [In-Chat MCP Events](/developer/platform/mcp/in-chat-mcp-events) — WebSocket/SSE events during a live chat.
...
See [In-Chat MCP Events](/developer/platform/mcp/in-chat-mcp-events) for the message schemas and recommended client handling.
