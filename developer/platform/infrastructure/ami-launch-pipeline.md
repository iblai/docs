...
**Tool**: `iblai infra service-update --host <IP>` from [iblai-infra-cli](https://github.com/iblai/infra-cli)
...
| Repository | Role |
|------------|------|
| [iblai-infra-cli](https://github.com/iblai/infra-cli) | CLI tool with `service-update` command, Ansible playbooks, Terraform templates |
