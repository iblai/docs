...
- [Infrastructure Architecture](/developer/infra-cli/architecture) — the platform side, if you are also self-hosting it
- [Sandbox server setup](/developer/guides/openclaw-server-setup) · [Sandbox server setup on a GPU host](/developer/guides/nemoclaw-server-setup) · [Sandbox platform integration](/developer/guides/claw-platform-integration)
- [MCP Servers](/developer/platform/mcp/mcp-servers) and [MCP & OAuth Architecture](/developer/platform/mcp/architecture) — how the platform models an MCP server connection
