...
> Mirrored from [`iblai/infra-cli`](https://github.com/iblai/infra-cli) · [`docs/architecture.md`](https://github.com/iblai/infra-cli/blob/main/docs/architecture.md). This page is generated — edit it in the repository, not here.
