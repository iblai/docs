...
> Mirrored from [`iblai/os`](https://github.com/iblai/os) · [`docs/standalone-deployment.md`](https://github.com/iblai/os/blob/main/docs/standalone-deployment.md). This page is generated — edit it in the repository, not here.
...
- **Output mode**: Set to `'standalone'` in [next.config.ts](https://github.com/iblai/os/blob/main/next.config.ts#L34)
...
### [post-build.sh](https://github.com/iblai/os/blob/main/scripts/post-build.sh)
...
### [server-wrapper.js](https://github.com/iblai/os/blob/main/server-wrapper.js)
...
- [Running the App Guide](/developer/os/running-the-app)
