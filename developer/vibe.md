...
[Desktop & Mobile](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-ops-build/SKILL.md)
[License: MIT](#license)
...
Once installed, start with [`/iblai-vibe-ops-init`](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-ops-init/SKILL.md) — it bootstraps a new ibl.ai project (or wires up an existing one) and writes the project `CLAUDE.md`.
...
See [`CLAUDE.md`](https://github.com/iblai/vibe/blob/main/CLAUDE.md#security-skills) for one-line descriptions.
...
[`/iblai-vibe-ops-deploy`](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-ops-deploy/SKILL.md). No Vercel
...
Add the Tauri shell (see [`/iblai-vibe-ops-build`](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-ops-build/SKILL.md)), then:
...
Once the Tauri shell is in place, [`/iblai-vibe-ops-release`](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-ops-release/SKILL.md)
...
[`references/credentials.md`](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-ops-release/references/credentials.md)):
...
[`references/signed-release.md`](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-ops-build/references/signed-release.md).
For a Windows Store / sideload **MSIX** package instead, see
[`/iblai-vibe-windows-msix`](https://github.com/iblai/vibe/blob/main/skills/iblai-vibe-windows-msix/SKILL.md).
