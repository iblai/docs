...
- Obtain all LTI parameters from the mentorAI team (tool URL, key set URL, login URL, etc.).
...
3. Fill in the fields:
   - **Tool name**: Mentor AI
   - **Tool URL**: provided by mentorAI
   - **Key set URL**: provided by mentorAI
   - **Login URL**: provided by mentorAI
   - **LTI version**: **1.3**
...
1. Navigate to the course where you want to add the mentor.
2. Click **Edit Mode** to enable editing.
3. Click the **+ Activity or Resource** button.
4. Select **Mentor AI** from the list (under Activities or Starred).
5. Click **Select Content** — a window opens showing all available mentors.
6. Choose the mentor you want to integrate (e.g., Career Path Mentor).
...
- The mentor loads directly in the course page.
- Students can chat with the mentor immediately.
...
- **Deep linking** allows instructors to select specific mentors per course module
- Enable **name and email sharing** for accurate learner analytics
- The mentor can be added to multiple courses with different mentor selections via deep linking
