...
**Superadministrator · Administrator · User** *(read-only access)*
...
Embed agents in course modules so users can get context-aware help alongside readings and assignments.
