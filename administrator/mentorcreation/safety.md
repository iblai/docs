...
The Safety panel lets you define two layers of content filtering—**Moderation** and **Safety prompts**—to keep Agentic OS conversations compliant and appropriate. By screening both incoming learner questions and outgoing AI responses, you protect users, meet institutional policies, and reduce the risk of harmful or off‑topic exchanges.
...
Block requests for cheating strategies and direct users toward legitimate study resources.
...
Filter out hate speech, harassment, or explicit content to protect user well‑being.
...
#### Administrator Confidence in AI Use

Deploy agents knowing robust safeguards are always active.

## Key Takeaway

Agentic OS’s Safety & Moderation system blocks harmful content at both the input and output level, detects evasion attempts, and logs flagged prompts for administrator review—ensuring every agent stays aligned with institutional guidelines and learner safety at all times.
