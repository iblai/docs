...
<iframe width="560" height="315" src="https://www.youtube.com/embed/wbXsAeKthfI" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
...
2. **Verify the textbook is loaded**  
   ...
   - Check for the **OpenStax Physics 101** (or relevant volume)  
   - Ensure it has a **green Trained badge** and **Visibility** set to **On**
...
4. **Review the sources**  
   ...
   - View **chapter location**, **relevance score**, and one-click access to the original page
