# Auto-Retraining Datasets

<iframe width="560" height="315" src="https://www.youtube.com/embed/-kopLzUyExI" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
...
#### Per-URL Scheduling
Set retraining intervals for **individual URL resources** directly from the **Datasets tab**.

#### Preset & Custom Intervals
...
#### Pick a URL Resource
- Locate the web resource you want to keep current (e.g., a documentation page, LMS module, or LinkedIn article).

#### Set the Retrain Interval
1. Click the **interval/clock icon** next to that URL.  
...
#### Faculty Blogs & Announcements
Auto-ingest new **guidance, examples, or announcements** posted publicly (e.g., faculty blogs, LinkedIn updates).

#### Program Documentation
Keep **onboarding guides and how-tos** updated each term without repeated uploads.
