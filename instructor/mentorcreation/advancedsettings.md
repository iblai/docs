...
<iframe width="560" height="315" src="https://www.youtube.com/embed/UnkafAWUToU" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
...
#### Customize Chat Box Width

- Adjust the width of the chat box (the **“Ask anything”** input area) from its default, smallest size
- Chat input area **widens or returns to default** based on the value you set.
...
## How to Use (Customize Chat Box Width)

<iframe width="560" height="315" src="https://www.youtube.com/embed/z0aAukIUzh4" title="YouTube video player" frameborder="0" allowfullscreen></iframe>

#### Open Tenant Settings
- Go to your **tenant settings → Advanced**.

#### Adjust Width
- Find **Chat area width**.  
- Hover the **info (i)** icon to see the *default* and *maximum* allowed values.  
- Enter a new width (demo example: **1,00**), then exit the settings.

#### Verify
- The chat box width updates **immediately**.

#### Revert (Optional)
- Return to **Chat area width** and **reset to default** to restore the original size.

The chat input area **widens or returns to default** based on the value you set.
