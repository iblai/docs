...
Keep **Web Search** on so students can research live data (stock prices, policy changes) within the chat.

#### Domain‑Specific Integrations

Use **MCP** to pull proprietary datasets—e.g., hospital records for nursing courses—without exposing raw files to students.
...
Turn on **Image Generation** for design classes, letting students prototype visuals directly in chat.
